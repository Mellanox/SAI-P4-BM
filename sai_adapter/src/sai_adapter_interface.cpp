...
sai_status_t sai_adapter_set_port_attribute(S_O_Handle p, sai_object_id_t port_id,
                                        sai_attribute_t *attr) {
  sai_adapter *q = (sai_adapter *)p;
  return q->set_port_attribute(port_id, attr);
}

sai_status_t sai_adapter_get_port_attribute(S_O_Handle p, sai_object_id_t port_id,
                                        uint32_t attr_count,
                                        sai_attribute_t *attr_list) {
  sai_adapter *q = (sai_adapter *)p;
...
sai_status_t sai_adapter_remove_bridge(S_O_Handle p, sai_object_id_t bridge_id) {
  sai_adapter *q = (sai_adapter *)p;
...
// FDB
sai_status_t sai_adapter_create_fdb_entry(S_O_Handle p, sai_fdb_entry_t *fdb_entry,
                                      uint32_t attr_count,
                                      const sai_attribute_t *attr_list) {
  sai_adapter *q = (sai_adapter *)p;
...
sai_status_t sai_adapter_set_vlan_attribute(S_O_Handle p, sai_object_id_t vlan_id,
                                        const sai_attribute_t *attr) {
  sai_adapter *q = (sai_adapter *)p;
  return q->set_vlan_attribute(vlan_id, attr);
}

sai_status_t sai_adapter_get_vlan_attribute(S_O_Handle p, sai_object_id_t vlan_id,
...
sai_status_t sai_adapter_set_vlan_member_attribute(S_O_Handle p,
                                               sai_object_id_t vlan_member_id,
                                               const sai_attribute_t *attr) {
  sai_adapter *q = (sai_adapter *)p;
  return q->set_vlan_member_attribute(vlan_member_id, attr);
}
sai_status_t sai_adapter_get_vlan_member_attribute(S_O_Handle p,
                                               sai_object_id_t vlan_member_id,
                                               const uint32_t attr_count,
                                               sai_attribute_t *attr_list) {
  sai_adapter *q = (sai_adapter *)p;
