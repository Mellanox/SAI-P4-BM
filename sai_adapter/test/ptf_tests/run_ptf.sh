sudo ip netns exec sw_net ./ptf/ptf --test-dir tests/ --pypath sai_thrift_src/gen-py --test-params "server='127.0.0.1';port_map_file='port_map.ini'" --interface 0@sw_port0 --interface 1@sw_port1 --interface 2@sw_port2 \
