...
#    /**
 ...
 # *    #SAI_FDB_FLUSH_ATTR_PORT_ID, and #SAI_FDB_FLUSH_ATTR_VLAN_ID
  ...
  def sai_thrift_remove_vlan_member(self, vlan_member_id):
    ...
    # TODO: we need to save bridge_id inside vlan_member data..
    # self.cli_client.RemoveTableEntry('table_egress_vlan_filtering', list_to_str([bridge_id, vlan_id, 0]))
    # self.cli_client.RemoveTableEntry('table_egress_vlan_filtering', list_to_str([bridge_id, vlan_id, 1]))
    return 0
