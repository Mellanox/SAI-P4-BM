...
class sai_fdb_flush_attr:
  SAI_FDB_FLUSH_ATTR_PORT_ID = 0
  SAI_FDB_FLUSH_ATTR_VLAN_ID = 1
  SAI_FDB_FLUSH_ATTR_ENTRY_TYPE = 2

  _VALUES_TO_NAMES = {
    0: "SAI_FDB_FLUSH_ATTR_PORT_ID",
    1: "SAI_FDB_FLUSH_ATTR_VLAN_ID",
    2: "SAI_FDB_FLUSH_ATTR_ENTRY_TYPE",
  }
