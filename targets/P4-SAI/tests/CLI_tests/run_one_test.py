...
def main():
    ...
    simple_switch_p = subprocess.Popen(
        ["/home/yonatanp/P4/SAI-P4-BM/targets/simple_switch/simple_switch", "-h"],
        stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
    simple_switch_p.wait()

    # start simple_switch
    simple_switch_p = subprocess.Popen(
        ["/home/yonatanp/P4/SAI-P4-BM/targets/simple_switch/simple_switch",
    ...
    cmd = ["/home/yonatanp/P4/SAI-P4-BM/tools/runtime_CLI.py",
    ...
    with open(command_path, "r") as f:
        ...
        sub_env["PYTHONPATH"] = pythonpath + \
                                "/home/yonatanp/P4/SAI-P4-BM/thrift_src/gen-py/"
