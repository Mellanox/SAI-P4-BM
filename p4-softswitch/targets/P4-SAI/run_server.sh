...
sudo -v
export ROUTER_THRIFT_PORT=9091
sudo ip netns exec sw_net ./simple_switch -i 0@router_port1 --thrift-port $ROUTER_THRIFT_PORT --notifications-addr ipc:///tmp/bmv2-router-notifications.ipc sai_router.json &
