sudo ./ptf/ptf --test-dir tests/ --pypath sai_thrift_src/gen-py --test-params port_map_file=\"port_map.ini\" --interface 0@sw_port0 --interface 1@sw_port1 --interface 2@sw_port2 \
    	 ...
    	 # sail2_new.L2AcceptedFrameType sail2_new.L21DBridgeBasicTest
    	  sail2_new.L21QBridgeAccess2AccessTest
    	 # sail2_new.L21QBridgeAccess2TrunkTest # sail2_new.L21QBridgeAccess2TrunkTest  sail2_new.L21QBridgeTrunk2TrunkTest # sail2_new.L21DLagTest sail2_new.L21QLagTest
